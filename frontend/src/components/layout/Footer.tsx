    ...
    <footer className="ft-root" role="contentinfo">
      ...
      <div className="container ft-container">
        ...
        <div className="ft-grid">
          <div className="ft-col ft-col--brand">
            ...
            <div className="ft-socials">
              <a href="#" className="ft-social" aria-label="Twitter / X"><Twitter size={15} /></a>
          ...
          <div className="ft-col">
            ...
            <nav>
              <ul className="ft-links">
                <li><Link to="/" className="ft-link">{t('nav.home')}</Link></li>
                <li><Link to="/search" className="ft-link">{t('nav.search')}</Link></li>
                <li><Link to="/lists" className="ft-link">{t('nav.lists')}</Link></li>
              </ul>
            </nav>
          </div>
          ...
          <div className="ft-col">
            ...
            <nav>
              <ul className="ft-links">
                <li><Link to="/profile" className="ft-link">{t('nav.profile')}</Link></li>
                <li><Link to="/login" className="ft-link">{t('nav.login')}</Link></li>
                <li><Link to="/register" className="ft-link">{t('nav.register')}</Link></li>
              </ul>
            </nav>
          </div>
          ...
          <div className="ft-col">
            ...
            <nav>
              <ul className="ft-links">
                <li><a href="#" className="ft-link">{t('footer.privacy')}</a></li>
                <li><a href="#" className="ft-link">{t('footer.terms')}</a></li>
                <li><a href="#" className="ft-link">{t('footer.contact')}</a></li>
              </ul>
            </nav>
          </div>
        </div>
        ...
        <div className="ft-bottom">
          <p className="ft-copy">
            <span className="ft-copy__sym" aria-hidden="true">©</span>
            <time dateTime={String(year)}>{year}</time> UFMDb. {t('footer.allRightsReserved')}
          </p>
          <p className="ft-made">
